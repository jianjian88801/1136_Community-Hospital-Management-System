    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="就诊号" prop="jiuzhenJiuzhen">
                       <el-input v-model="ruleForm.jiuzhenJiuzhen"
                                 placeholder="就诊号" clearable  :readonly="ro.jiuzhenJiuzhen"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="就诊号" prop="jiuzhenJiuzhen">
                           <el-input v-model="ruleForm.jiuzhenJiuzhen"
                                     placeholder="就诊号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="就诊费用" prop="jiuzhenFeiyong">
                       <el-input v-model="ruleForm.jiuzhenFeiyong"
                                 placeholder="就诊费用" clearable  :readonly="ro.jiuzhenFeiyong"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="就诊费用" prop="jiuzhenFeiyong">
                           <el-input v-model="ruleForm.jiuzhenFeiyong"
                                     placeholder="就诊费用" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="挂号备注" prop="jiuzhenText">
                        <el-input type="textarea"  :readonly="ro.jiuzhenText" v-model="ruleForm.jiuzhenText" placeholder="挂号备注"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiuzhenText" label="挂号备注" prop="jiuzhenText">
                            <span v-html="ruleForm.jiuzhenText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="挂号详情" prop="jiuzhenContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.jiuzhenContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiuzhenContent" label="挂号详情" prop="jiuzhenContent">
                            <span v-html="ruleForm.jiuzhenContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    jiuzhenJiuzhen: false,
                    jiuzhenFeiyong: false,
                    keshiTypes: false,
                    insertTime: false,
                    jiuzhenText: false,
                    jiuzhenContent: false,
                },
                ruleForm: {
                    yonghuId: '',
                    jiuzhenJiuzhen: '',
                ...
                rules: {
                   ...
                   jiuzhenFeiyong: [
                              { required: true, message: '就诊费用不能为空', trigger: 'blur' },
                          ],
                   keshiTypes: [
                   ...
                   jiuzhenText: [
                              { required: true, message: '挂号备注不能为空', trigger: 'blur' },
                          ],
                   jiuzhenContent: [
                              { required: true, message: '挂号详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jiuzhen/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jiuzhenCrossAddOrUpdateFlag = false;
                                        this.parent.search();
